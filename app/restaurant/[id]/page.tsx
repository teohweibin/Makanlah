  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-8">
      ...
      <section className="mb-8">
        <h2 className="mb-4 font-[family-name:var(--font-display)] text-lg font-semibold uppercase tracking-wide text-[var(--color-ink)]">
          {'\uD83D\uDD27'} Kitchen To-Do ({pendingGroups.length})
        </h2>
